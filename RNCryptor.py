...
def main():
    ...
    ########encrypt###########
    yourimail_password = "123456"
    encrypt_password =  cryptor.encrypt(yourimail_password,password)
    en_yourimail_password = base64.b64encode(encrypt_password)
    #######decrypt##########
    yourimail_password_base64encode = "AwHwuoW1uMGcGGZF6oF1a9FqQr2iC+iiTnrxvGM3993BnsCoRdL0GqzEUJvMPCvKnWoSeLIcQQTGmE/EDJYFaif9WhYLNg2szfG8S4GQIWgPMA=="
